...
`go-ruby-commonmark/commonmark` reimplements Ruby's `commonmark` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-commonmark/commonmark` directly, with no Ruby runtime;
